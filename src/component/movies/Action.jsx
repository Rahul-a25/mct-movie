...
const Action = () => {
    ...
    const url='https://api.themoviedb.org/3/movie/popular?api_key=242efbc4712f4c03c1e8c51afa2afe05&language=en-US&page=190';
  const SEARCHAPI =
   ...
   ApiData.map((e)=>(
    ...
    <Link style={{color:"black",textDecoration:"none"}} to={`/MoviedetailPage/${e.id}`} key={e.id}>
      ...
      <Card.Body style={{backgroundColor:"#232425"}}>
        ...
        <Card.Text style={{color:"white",fontSize:"20px",}}>{e.vote_average}</Card.Text>  </div> 
